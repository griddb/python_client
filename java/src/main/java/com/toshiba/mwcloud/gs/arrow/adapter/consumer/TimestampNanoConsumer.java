 ...
 * TimeStampNanoVector}.
 */
public abstract class TimestampNanoConsumer {

  /** Creates a consumer for {@link TimeStampNanoVector}. */
  public static JavaAPIConsumer<TimeStampNanoVector> createConsumer(
      TimeStampNanoVector vector, int index, boolean nullable) {
    if (nullable) {
  ...
  static class NullableTimestampConsumer extends BaseConsumer<TimeStampNanoVector> {


    /** Instantiate a TimestampConsumer. */
    public NullableTimestampConsumer(TimeStampNanoVector vector, int index) {
      super(vector, index);
    }
  ...
  static class NonNullableTimestampConsumer extends BaseConsumer<TimeStampNanoVector> {

    public NonNullableTimestampConsumer(TimeStampNanoVector vector, int index) {
      super(vector, index);
    }
